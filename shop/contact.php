        ...
        <div class="header__bottom">
            ...
            <div class="header__bottom--menu">
                <ul>
                    ...
                    <li><a href="contact.php" class="selected_menu">liên hệ</a></li>
                </ul>
            </div>
        ...
        <div class="container">
            ...
            <div class="main__contact--left">
                ...
                <form action="contact.php" method="post">
                    ...
                    <textarea name="content" id="" cols="20" rows="10" placeholder="Nhập nội dung">

                    </textarea>

                    <input type="submit" name="submit_Contact" value="Gửi liên hệ">
            ...
            <div class="main__contact--right">

                <div>
                    <i class="fas fa-map-marker-alt"></i>
                    <div>
                        <b>Địa chỉ liên hệ</b>
                        <p><?php echo (isset($contact_address)) ? $contact_address : ""; ?></p>
                    </div>
...
// xử lý gửi gmail
require_once 'handler_send_mail.php';
