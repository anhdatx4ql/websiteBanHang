        ...
        <div class="container">
            ...
            <div class="main__news--content">
                ...
                <div class="main__news--content__left">
                    ...
                    <div class="new_short_detail">

                        <?php

                        $new = new handler_database();

                        if (isset($_POST['submit_search_new_title'])) {

                            $new = new handler_database();

                            // thêm dấu \ trước kí tự ',"
                            $search = str_replace('"', '\\"', trim($_POST['text']));
                            $search = str_replace("'", "\\'", $search);

                            $sql = 'select* from news where new_title like \'%' . $search . '%\'';
                            ...
                            foreach ($result as $item) {
                                echo "<div>
                                            ...
                                            <form action=\"news.php\" method=\"post\">
                                                ...
                                                <input type=\"submit\" name=\"submit_new\" value=\"Chi tiết\">
                                            </form>

                                        </div>";
                            }

                        } else echo "<div><p>Không tìm thấy tin tức</p></div>";
...
if (isset ($_POST['submit_search_new_title'])) {
    // hiển thị thông tin tìm kiếm lên form sau khi load lại trang
    echo "<script>document.querySelector('.main__news--content__right--search input[type=\"text\"]').value = '" . $search . "'; </script>";
